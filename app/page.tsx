  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-white border-b px-4 py-3">
        <div className="max-w-2xl mx-auto flex items-center gap-2 text-gray-600">
          <span>📍</span>
      ...
      <div className="max-w-2xl mx-auto px-4 py-4">
        <input 
          ...
          className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-primary/50"
        />
      </div>

      {/* Categories */}
      <div className="max-w-2xl mx-auto px-4 pb-4 flex gap-3 overflow-x-auto">
        {[
                  ...
                  {items.map(item => (
                    <div key={item.id} className="bg-white rounded-xl p-4 shadow-sm flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-primary font-semibold">KES {item.price}</p>
                      </div>
                      <button
                        onClick={() => addToCart(item)}
                        className="bg-primary hover:bg-secondary text-white px-4 py-2 rounded-full font-medium transition"
                      >
                        Add
                      </button>
                    </div>
            ...
            <div className="p-6">
              ...
              {cart.length === 0 ? (
                ...
                <>
                  ...
                  <button className="w-full bg-primary hover:bg-secondary text-white py-4 rounded-xl font-semibold mt-6 transition">
                    Place Order
                  </button>
                </>
              )}
